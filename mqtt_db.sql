...
INSERT INTO `conn_clients` (`id_conn`, `id_user`, `client_id`, `client_address`, `client_port`, `device_id`) VALUES
	(1056, 7, 'ESP8266Client-985b', '192.168.1.109', 37425, 0);
...
-- Copiando dados para a tabela mqtt.conn_log: ~672 rows (aproximadamente)
...
-- Copiando dados para a tabela mqtt.mqtt_metrics: ~1.480 rows (aproximadamente)
...
-- Copiando dados para a tabela mqtt.tp_subscribe: ~589 rows (aproximadamente)
