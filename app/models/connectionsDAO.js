...
connectionsDAO.prototype.conn_db_insert = function(user_id, client_id, client_address, client_port, callback) {
	...
	conn.beginTransaction(function(err) {
		...
		conn.query("insert into conn_clients(id_user, client_name, client_address, client_port) values('"+user_id+"','"+client_id+"','"+client_address+
			...
			conn.query("insert into conn_log(id_user, client_name, client_address, client_port) values('"+user_id+"','"+client_id+"','"+client_address+
			"',"+client_port+")", function(err, result) {
				if (err) {
					conn.rollback(function() {
						callback(err, null);
...
connectionsDAO.prototype.conn_db_delete = function(user_id, client_id, client_address, client_port, callback) {
	var query = "delete from conn_clients where id_user = "+user_id+" and client_name  = '"+client_id+"' and client_address = '"+client_address+"' and client_port = "+client_port;
